#----------------------- Analyze the volumetry of the data after cleaning and before splitting ---------------------------
...
liste_cleaned_data = os.listdir("../data/onh/data_00_onh/Images/data")


liste_path_cleaned = []

for name in liste_cleaned_data:
    name = name[:-15] + ".dcm"
    name = "Images/"+name
    liste_path_cleaned.append(name)



df = df[df["path"].isin(liste_path_cleaned)]
...
plt.savefig('graphs_volumetry_data/after_cleaning_and_before_splitting/number_of_data_per_patient.png')
